...
export default function Login() {
  return (
    <>
      ...
      <Head>
        <title className='bg-white'>Login Page</title>
      </Head>
          ...
          <div className="max-w-md w-full space-y-8">
            ...
            <form className="mt-8 space-y-6 cursor-pointer">
              ...
              <div className='p-4' >
                ...
                <div className='p-4'>
                  <label htmlFor="password" className="sr-only text-red-900"><span>password</span></label>
              ...
              <div>
                <button type="submit" 
                  className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-950 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                  Sign Up
                </button>
              </div>
            </form>
